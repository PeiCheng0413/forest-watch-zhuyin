...
const PAGES=[
 ...
 {chapter:'第三幕 · 森林邊境的守望',title:'現在，讓我們一起守住它。',speaker:'邊境賢者',paragraphs:['塔上的王國弓箭手已經拉開長弓。哥布林與獸人正從四周湧來——請辨識牠們的真名，協助魔法師削弱敵人，守住王國的邊境箭塔。','擊敗魔物留下的魔石，會逐漸積滿能量。魔杖蓄滿後會發光。清空輸入，連按兩下空白鍵，戰場便暫時凝結；你讀出完整咒語，魔法師便能喚來「曙光降臨」，清除眼前的魔物。'],aside:'「不必急著成為英雄。先讀出第一個名字，剩下的，交給我們一起完成。」',reveal:true}
];
class StoryBook{
